...
<input class="input-style" type="text" name="country" value="<%=rs2.getString(10) %>" placeholder="Enter Country" required>
	...
	<h3 style="color: yellow">*If there is no address it means that you did not set your address!</h3>
	<h3 style="color: yellow">*This address will also get updated to your profile</h3>
	<hr style="width: 100%">
	<div class="left-div">
...
<option value="Online Payment">Online Payment</option>
	...
	<div class="right-div">
		<h3>Pay online on this dipalikarna@pay.com</h3>
